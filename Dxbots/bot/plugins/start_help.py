        ...
        try:
            ...
            if user.status == "kicked":
             ...
             await DxStreamBot.send_photo(
                chat_id=m.chat.id,
                photo="https://telegra.ph/file/69bff99fa1ae9cfd41e68.jpg",
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<i>Something went wrong</i> <b> <a href='https://t.me/crezyDeveloperSupport'>CLICK HERE FOR SUPPORT </a></b>",
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [Support](https://t.me/crezyDeveloperSupport).",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ Owner", url="https://t.me/crezydevelopers")],
